                    ...
                    <div className="col col-xs-12 margin-top-5">
                        ...
                        <div id='ppBody'>
                            ...
                            <div className='grayText'><strong>What personal information do we collect from the people
                                that
                                visit our blog, website or app?</strong></div>
                            <br />
                            <div className='innerText'>When ordering or registering on our site, as appropriate, you may
                                be
                                asked to enter your name, email address, IP or other details to help you with your
                                experience.
                            </div>
                            <br />
                            ...
                            <br />Play game <span id='infoUs'></span><br />
                            ...
                            <div className='innerText'> We may use the information we collect from you when you
                                ...
                                the following ways:<br /></div>
                            <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To
                            ...
                            <div className='innerText'>An external PCI compliant payment gateway handles all CC
                                transactions.
                            </div>
                            ...
                            <br />
                            <div className='innerText'>We implement a variety of security measures when a user
                                enters, submits, or accesses their information to maintain the safety of
                                your personal information.
                            </div>
                            <br />
                            <div className='innerText'>All transactions are processed through a gateway
                            ...
                            <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&bull;</strong>
                            ...
                            <div className='innerText'><br />You can choose to have your computer warn you
                                ...
                                way to modify your cookies.<br /></div>
                            <div className='innerText'><br /><strong>If users disable cookies in their
                                browser:</strong></div>
                            <br />
                            <div className='innerText'>If you turn cookies off, Some of the features
                            ...
                            <br />
                            <div className='innerText'>We do not sell, trade, or otherwise transfer
                                to outside parties your Personally Identifiable Information
                                unless we provide users with advance notice. This does not
                                ...
                                safety.<br /> However, non-personally identifiable visitor
                            ...
                            <br />
                            <div className='innerText'>Occasionally, at our discretion, we may
                            ...
                            <br />
                            <div className='innerText'>Google's advertising requirements can be
                                summed up by Google's Advertising Principles. They are put in
                                place to provide a positive experience for users.
                                https://support.google.com/adwordspolicy/answer/1316548?hl=en
                                <br /></div>
                            <div className='innerText'>We use Google AdSense Advertising on our
                                website.
                            </div>
                            <div className='innerText'><br />Google, as a third-party vendor, uses
                                cookies to serve ads on our site. Google's use of the DART
                                cookie enables it to serve ads to our users based on previous
                            ...
                            <div className='innerText'><br /><strong>We have implemented the
                                following:</strong></div>
                            <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <strong>&bull;</strong> Remarketing with Google AdSense
                            </div>
                            <br />
                            <div className='innerText'>We, along with third-party vendors such
                                as Google use first-party cookies (such as the Google
                            ...
                            <div className='blueText'><strong>California Online Privacy
                                Protection Act</strong></div>
                            <br />
                            <div className='innerText'>CalOPPA is the first state law in the
                            ...
                            <div className='innerText'><br /><strong>According to CalOPPA, we
                                agree to the following:</strong><br /></div>
                            <div className='innerText'>Users can visit our site anonymously.
                            </div>
                            <div className='innerText'>Once this privacy policy is created, we
                                will add a link to it on our home page or as a minimum, on
                                the first significant page after entering our website.<br />
                            </div>
                            <div className='innerText'>Our Privacy Policy link includes the word
                                'Privacy' and can easily be found on the page specified
                                above.
                            </div>
                            <div className='innerText'><br />You will be notified of any Privacy
                                Policy changes:
                            </div>
                            <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <strong>&bull;</strong> On our Privacy Policy Page<br /></div>
                            <div className='innerText'>Can change your personal information:
                            </div>
                            <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <strong>&bull;</strong> By logging in to your account
                            </div>
                            <div className='innerText'><br /><strong>How does our site handle Do
                                Not Track signals?</strong><br /></div>
                            <div className='innerText'>We honor Do Not Track signals and Do Not
                                Track, plant cookies, or use advertising when a Do Not Track
                                (DNT) browser mechanism is in place.
                            </div>
                            <div className='innerText'><br /><strong>Does our site allow
                                third-party behavioral tracking?</strong><br /></div>
                            <div className='innerText'>It's also important to note that we allow
                            ...
                            <div className='blueText'><strong>COPPA (Children Online Privacy
                                Protection Act)</strong></div>
                            <br />
                            <div className='innerText'>When it comes to the collection of
                                personal information from children under the age of 13 years
                                old, the Children's Online Privacy Protection Act (COPPA)
                                puts parents in control. The Federal Trade Commission,
                                United States' consumer protection agency, enforces the
                                COPPA Rule, which spells out what operators of websites and
                                online services must do to protect children's privacy and
                                safety online.<br /><br /></div>
                            <div className='innerText'>We do not specifically market to children
                                under the age of 13 years old.
                            </div>
                            <div className='innerText'>Do we let third-parties, including ad
                            ...
                            <br />
                            <div className='innerText'>The CAN-SPAM Act is a law that sets the
                                ...
                                penalties for violations.<br /><br /></div>
                            <div className='innerText'><strong>We collect your email address in
                                order to:</strong></div>
                            <div className='innerText'><br /><strong>To be in accordance with
                                CANSPAM, we agree to the following:</strong></div>
                            <div className='innerText'><strong><br />If at any time you would like
                                to unsubscribe from receiving future emails, you can email
                                us at</strong></div>
                        ...
                        <div className='innerText'>https://typitap.com</div>
                        <div className='innerText'><br />Last Edited on 2017-06-30</div>
                    </div>
                </div>
            </div>
