            ...
            <div style={{paddingTop: "40px"}}>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col col-xs-12">
                            <Accordion>
                                <Panel header="What is typitap?" eventKey={1}>
                                    <p>
                                ...
                                <Panel header="How is my score calculated?" eventKey={2}>
                                    <p>
                                ...
                                <Panel header="How is accuracy calculated?" eventKey={3}>
                                ...
                                <Panel header="How can I contribute?" eventKey={4}>
                                ...
                                <Panel header="What's the 'follow' feature?" eventKey={5}>
                                ...
                                <Panel header="I can't see my progress chart" eventKey={6}>
                                ...
                                <Panel header="What are the benefits of signing up?" eventKey={7}>
                                    <ul>
